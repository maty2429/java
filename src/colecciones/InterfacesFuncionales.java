...
public class InterfacesFuncionales {
    public static void main(String[] args) {
        ...
        // DEMO EJECUTABLE
        // -------------------------------------------------------------------------
        System.out.println("Tema: Interfaces funcionales");
        System.out.println("Nota: el apunte original de este archivo parece cubrir Stream API; se conserva completo abajo para revisarlo después.");

        Predicate<Integer> esPar = numero -> numero % 2 == 0;
        Function<Integer, String> describir = numero -> "Numero " + numero;
        Consumer<String> imprimir = System.out::println;
        Supplier<Integer> generarBase = () -> 10;

        int valor = generarBase.get();
        if (esPar.test(valor)) {
            imprimir.accept(describir.apply(valor));
        }
